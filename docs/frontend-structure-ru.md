...
- `/artists/:username` — публичный профиль артиста и его approved-треки
...
- `features/artists/ArtistsPanel.tsx` — публичный список artist profiles
- `features/artists/ArtistDetailPage.tsx` — профиль артиста и approved-треки
- `features/artists/ArtistProfileEditor.tsx` — редактирование собственного artist profile в `/me`
